...
namespace TempJobsWcf
{
    ...
    partial void InsertReportJob(ReportJob instance);
    partial void UpdateReportJob(ReportJob instance);
    partial void DeleteReportJob(ReportJob instance);
    #endregion
		...
		public System.Data.Linq.Table<ReportJob> ReportJobs
		{
			get
			{
				return this.GetTable<ReportJob>();
			}
		}
	}
	...
	public partial class Employer : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ReportJob> _ReportJobs;
    ...
    partial void OnProfileImage_StringChanged();
		...
		public Employer()
		{
			...
			this._ReportJobs = new EntitySet<ReportJob>(new Action<ReportJob>(this.attach_ReportJobs), new Action<ReportJob>(this.detach_ReportJobs));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employer_ReportJob", Storage="_ReportJobs", ThisKey="EmployerID", OtherKey="EmployerID")]
		public EntitySet<ReportJob> ReportJobs
		{
			get
			{
		...
		private void attach_ReportJobs(ReportJob entity)
		{
			this.SendPropertyChanging();
			entity.Employer = this;
		}
		
		private void detach_ReportJobs(ReportJob entity)
		{
			this.SendPropertyChanging();
			entity.Employer = null;
		}
    ...
    partial void OnIsAvailableChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="JobSeeker_ReportJob", Storage="_ReportJobs", ThisKey="JobSeekerID", OtherKey="JobSeekerID")]
		public EntitySet<ReportJob> ReportJobs
		{
			get
			{
    ...
    partial void OnEmployerIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Job_ReportJob", Storage="_ReportJobs", ThisKey="JobID", OtherKey="JobID")]
		public EntitySet<ReportJob> ReportJobs
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ReportJob")]
	public partial class ReportJob : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _ReportJobID;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnReportJobIDChanging(int value);
    partial void OnReportJobIDChanged();
    partial void OnEmployerIDChanging(int value);
    partial void OnEmployerIDChanged();
    partial void OnJobSeekerIDChanging(int value);
    partial void OnJobSeekerIDChanged();
    ...
    partial void OnCommentChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ReportJobID", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int ReportJobID
		{
			get
			{
				return this._ReportJobID;
			}
			set
			{
				if ((this._ReportJobID != value))
				{
					this.OnReportJobIDChanging(value);
					this.SendPropertyChanging();
					this._ReportJobID = value;
					this.SendPropertyChanged("ReportJobID");
					this.OnReportJobIDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employer_ReportJob", Storage="_Employer", ThisKey="EmployerID", OtherKey="EmployerID", IsForeignKey=true)]
		public Employer Employer
		{
			get
			{
			...
			set
			{
							...
							|| (this._Employer.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Employer.Entity = null;
						previousValue.ReportJobs.Remove(this);
					}
					this._Employer.Entity = value;
					if ((value != null))
					{
						value.ReportJobs.Add(this);
						this._EmployerID = value.EmployerID;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Job_ReportJob", Storage="_Job", ThisKey="JobID", OtherKey="JobID", IsForeignKey=true)]
		public Job Job
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="JobSeeker_ReportJob", Storage="_JobSeeker", ThisKey="JobSeekerID", OtherKey="JobSeekerID", IsForeignKey=true)]
		public JobSeeker JobSeeker
		{
			get
			{
