...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="padding-left:20%; padding-right: 20%">
         <div class ="card" style="padding-left:10%; padding-right:10%; /*border:ridge*/">
             ...
             <div class="row">
                 <div class="col-md-3" style ="padding-right: 5%">
                     <asp:Button ID="btnYes" class="btn btn-success" style="border-radius:initial" runat="server" Text="Yes" width="100" OnClick="btnYes_Click" />
                 </div>
                 <div class="col-md-3" style="padding-left: 5%; padding-right: 5%">
                     <asp:Button ID="btnNo" class="btn btn-block" style="border-radius:initial" runat="server" Text="No" OnClick="btnNo_Click" />
                 </div>
             </div>
            <br />
         </div>
